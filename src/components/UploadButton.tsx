                    ...
                    <label
                        ...
                        <div className='flex flex-col items-center justify-center pt-5 pb-6'>
                            ...
                            <p className='mb-2 text-sm text-zinc-700'>
                                <span className='font-semibold'>Drag and drop</span> your PDF file here
                            </p>
                        ...
                        {isUploading ? (
                            <div className='w-full mt-4 max-w-xs mx-auto'>
                                ...
                                {uploadProgress === 100 ? (
                                    <div className='flex items-center justify-center text-sm text-zinc-700 text-center pt-2'>
